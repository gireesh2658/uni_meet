...
const AppointmentCard = ({ appointment, showFaculty = true, showStudent = false, actions }: AppointmentCardProps) => (
  <div className="rounded-xl border border-border bg-card p-4 shadow-sm transition-shadow hover:shadow-md">
    ...
    <div className="mt-3 flex flex-wrap gap-4 text-sm text-muted-foreground">
      ...
      <span className="flex items-center gap-1"><Clock className="h-3.5 w-3.5" />{appointment.startTime} – {appointment.endTime}</span>
    </div>
