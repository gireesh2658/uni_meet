      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link to="/login?role=student" className="rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-sm transition-colors hover:bg-primary/90">
              Login as Student
            </Link>
            <Link to="/login?role=faculty" className="rounded-lg bg-secondary px-6 py-3 text-sm font-semibold text-secondary-foreground shadow-sm transition-colors hover:bg-secondary/90">
              Login as Faculty
            </Link>
            <Link to="/login?role=admin" className="rounded-lg border border-border bg-card px-6 py-3 text-sm font-semibold text-foreground shadow-sm transition-colors hover:bg-muted">
              Admin Login
            </Link>
          </div>
        </div>
